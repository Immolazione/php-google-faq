...
$faq_branch = [
    ...
    [
        ...
        "paragraphs" => [
            ...
            "<li><ol><li>Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell'Unione europea, oltre a Islanda, Liechtenstein e Norvegia) o in Svizzera.</li>",
...
<body>
    ...
    <div>
        <?php foreach($faq_branch as $question): ?>
            <h2><?= $question['title'] ?></h2>
            <?php foreach($question['paragraphs'] as $paragraph) echo $paragraph ?>
        <?php endforeach; ?>
    </div>
